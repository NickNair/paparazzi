...
#ifndef COLOR_OBJECT_DETECTOR_SCREENPOS_CV_H
#define COLOR_OBJECT_DETECTOR_SCREENPOS_CV_H
...
// Module functions
extern void color_object_detector_screenpos_init(void);
extern void color_object_detector_screenpos_periodic(void);
